...
const CE_END = 2024;           // max timeline year
...
export default function Home() {
  ...
  // NEW: controls welcome popup visibility
  ...
  }, [range, refreshTick, classificationFilter, countryFilter, cultureFilter, museum]);
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: '#f7efe7', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            >
              ...
              <label style={{ display: 'block', marginBottom: '0.75rem', fontSize: '0.85rem' }}>
                ...
                >
                  ...
                  <option value="walter">Walters Art Museum</option>
                </select>
              </label>
        ...
        {showWelcome && (
          <div
            style={{
              ...
              zIndex: 10000, // above spinner + header
            }}
          >
            <div
              style={{
            ...
            >
              ...
              >
                Explore human history through art by scrolling through time and
                discovering artifacts from different cultures, eras, and places.
              </p>
              <button
                className="btn-red"
                type="button"
        ...
        {/* Spinner overlay (only once popup is gone) */}
